...
export class ContentDto {
  ...
  body?: string[];
  @ApiPropertyOptional() @IsOptional() @IsMongoId() coverMediaId?: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsUrl({ protocols: ["https"], require_protocol: true }) @MaxLength(500) videoUrl?: string;
