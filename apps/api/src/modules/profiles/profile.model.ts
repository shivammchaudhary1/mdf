...
export const ProfileSchema = new Schema<Profile>(
  {
    ...
    portfolioMediaIds: {
      ...
      default: undefined,
      validate: {
        validator: (value?: Types.ObjectId[]) => !value || value.length <= 8,
        message: "Portfolio can contain up to 8 photographs.",
      },
    },
