...
export type ProfileRecord = {
  ...
  videos?: string[]; showreel?: string; previousWork?: string; socialLinks?: string[];
  resume?: string; resumeMediaId?: string; publicVisible?: boolean; emailCastingAlerts?: boolean; emailUpdates?: boolean;
...
export type UploadedMediaResult = { id: string; kind: "image" | "document"; visibility: "private" | "public"; urls: Record<string,string>; duplicate?: boolean };
