export const placeholderHomeContent = {
  ...
  manifesto: {
    ...
    description:
      "We are building a place where production, people and opportunity can live together without losing the human side of storytelling.",
  },
  sections: {
    projects: {
      eyebrow: "Featured projects",
      title: "Stories in the making.",
      description: "A focused look at what is moving from idea to screen.",
    },
    casting: {
      eyebrow: "Casting & crew",
      title: "Find your next opportunity.",
      description: "Open calls should be clear, practical and easy to act on.",
    },
    behindTheScenes: {
    ...
    team: {
      ...
      description: "A portrait-led section for the people building the work.",
    },
  },
