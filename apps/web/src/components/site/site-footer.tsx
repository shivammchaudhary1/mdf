...
export function SiteFooter() {
  ...
  return (
    <footer className="w-full border-t border-black/6 bg-[#f8f7f4]">
      <div className="site-shell grid gap-10 py-11 sm:grid-cols-2 sm:py-12 lg:grid-cols-[1.25fr_.78fr_.78fr_1fr] lg:gap-12 lg:py-14">
            ...
            {socialEntries.map(({ name, href }) =>
              href ? (
                <a
                  ...
                  className="grid h-9 w-9 place-items-center rounded-full border border-black/10 bg-white text-[#343434] transition hover:border-[var(--brand-red)] hover:bg-[var(--brand-red)] hover:text-white"
                >
                ...
                <span
                  ...
                  className="grid h-9 w-9 place-items-center rounded-full border border-black/7 bg-white text-[#b1b1b1]"
                >
                  <SocialIcon name={name} />
                </span>
              ),
        ...
        <div>
          ...
          <h3 className="font-display mt-4 text-2xl font-semibold leading-tight text-[#171717]">Your next opportunity could start here.</h3>
