...
export function LoadingState({ label = "Loading your experience…" }: { label?: string }) {
  return (
    <div role="status" className="grid min-h-[44vh] place-items-center px-5 py-20">
      <div className="flex flex-col items-center text-center">
        <BrandLogo darkInk className="!w-[118px]" />
        <div className="mt-7 h-11 w-11 animate-spin rounded-full border-[3px] border-slate-200 border-t-[var(--brand-red)] motion-reduce:animate-none" />
