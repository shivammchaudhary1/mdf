 ...
 return <div className="ad-shell">
  ...
  <div className="ad-main">
   <header className="ad-topbar">
    ...
    <div className="ad-topbar-right"><label className="ad-global-search"><AdminIcon name="search"/><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search platform"/><kbd>⌘ K</kbd></label><button className="ad-icon-button"><AdminIcon name="bell"/><i/></button><div className="ad-avatar ad-avatar-top">{data.admin.initials}</div></div>
   </header>
