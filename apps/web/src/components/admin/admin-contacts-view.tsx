...
export function AdminContactsView(){
 const toast=useToast();const[contacts,,refresh]=useAdminRecords("/admin/contacts",contactView);const[selectedId,setSelectedId]=useState("");const selected=contacts.find(x=>x.id===selectedId)??contacts[0]??{id:"",name:"",email:"",subject:"",message:"",status:"",received:""};
