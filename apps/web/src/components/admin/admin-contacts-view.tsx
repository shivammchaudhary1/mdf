...
export function AdminContactsView(){
 const toast=useToast();const[contacts,,refresh,meta,setPage,,loading,error]=useAdminRecords("/admin/contacts",contactView,true,1,20);const[selectedId,setSelectedId]=useState("");const selected=contacts.find(x=>x.id===selectedId)??contacts[0]??{id:"",name:"",email:"",subject:"",message:"",status:"",received:""};
